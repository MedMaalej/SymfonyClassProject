...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'C:\\xampp\\htdocs\\Symfony\\src\\Formation\\FormationBundle\\Entity')), 'Formation\\FormationBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('FormationFormationBundle' => 'Formation\\FormationBundle\\Entity'));
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context._login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/secured/login$'), 'security.firewall.map.context._secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/secured/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $i = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $h, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($h, '_'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '_logout'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\xampp\\htdocs\\Symfony\\src\\Formation\\FormationBundle/Resources/views', 'FormationFormation');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c9767ec7afcc89ed2f9995f1ba44e66b');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FormationFormationBundle' => 'Formation\\FormationBundle\\FormationFormationBundle',
            ...
            'locale' => 'en',
            'secret' => 'c9767ec7afcc89ed2f9995f1ba44e66b',
            'debug_toolbar' => true,
            ...
            'kernel.secret' => 'c9767ec7afcc89ed2f9995f1ba44e66b',
